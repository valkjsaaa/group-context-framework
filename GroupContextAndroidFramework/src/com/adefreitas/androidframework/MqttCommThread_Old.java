...
public class MqttCommThread_Old extends CommThread implements MqttCallback
{
     ...
     * @param cw
     */
    public MqttCommThread_Old(CommManager commManager, String deviceID, String serverIP, int port, Handler commHandler, ContextWrapper cw)  
	{
    	super(commManager);
			...
			public void run()
			{
				try
				{
					if (channel != null && !channels.contains(channel))
					{
						...
						((AndroidCommManager)(getCommManager())).notifySubscribed(MqttCommThread_Old.this, channel);
					}
				}
				catch (Exception ex)
				{
	...
	public class ConnectionThread extends Thread
	{
		public void run()
		{
			try
			{
				...
				client.setCallback(MqttCommThread_Old.this);
				...
				if (client.isConnected())
				{
					...
					((AndroidCommManager)(getCommManager())).notifyConnected(MqttCommThread_Old.this);	
				}
			}
			catch (Exception ex)
			{
