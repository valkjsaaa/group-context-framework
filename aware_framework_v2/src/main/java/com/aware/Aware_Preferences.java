...
public class Aware_Preferences extends PreferenceActivity {
    ...
    private static final int DIALOG_MQTT_ID = 2;
    private static final int DIALOG_ERROR_MISSING_PARAMETERS = 3;
    private static final int DIALOG_ERROR_MISSING_SENSOR = 4;
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch(id) {
            ...
            break;
            case DIALOG_MQTT_ID:
                builder.setMessage("Your device ID is: " + Aware.getSetting(getContentResolver(), "device_id").hashCode());
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
