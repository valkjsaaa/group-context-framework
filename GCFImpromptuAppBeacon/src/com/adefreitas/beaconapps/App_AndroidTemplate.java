...
public class App_AndroidTemplate extends AndroidApplicationProvider
{	
	 ...
	 * @param port
	 */
	public App_AndroidTemplate(GCFApplication application, GroupContextManager groupContextManager, CommMode commMode, String ipAddress, int port)
	{
