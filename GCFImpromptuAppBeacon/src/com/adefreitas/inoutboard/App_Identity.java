...
public class App_Identity extends AndroidApplicationProvider
{	
	 ...
	 * @param port
	 */
	public App_Identity(GCFApplication application, UserIdentityContextProvider identityProvider, GroupContextManager groupContextManager, CommMode commMode, String ipAddress, int port)
	{
