...
//		this.setProxyDeviceID("IMPROMPTU_STI_PRINTERS");
	...
	public String getFunctions()
	{
		...
		ApplicationFunction wordFunction 	   = new ApplicationFunction(this.getAppID(), "Print Document (" + printerName + ")", "Prints a *.docx file using default settings.");
		ApplicationFunction powerPointFunction = new ApplicationFunction(this.getAppID(), "Print Handouts (" + printerName + ")", "Converts a *.pptx file into handouts.");
